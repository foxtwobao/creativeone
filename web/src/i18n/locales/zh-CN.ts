export default {
    ...
    canvas: {
        ...
        export: { defaultProjectName: "画布ONE", defaultNodesName: "画布元素", item: "元素" },
        createMenu: {
    ...
    home: {
        promptError: "获取提示词失败",
        description: "在 <canvas>画布ONE</canvas> 中生成、连接和重组 <content>图片、文字与图形</content>，让创作从单次生成变成连续推演。",
        start: "开始使用",
        openCanvas: "打开画布",
